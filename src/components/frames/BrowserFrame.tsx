  ...
  return (
    ...
    >
      ...
      >
        ...
        {!isChrome && (
          <div
            className={`flex-1 flex items-center justify-center gap-1 mx-2 px-2 py-[1px] text-[5px] rounded ${
              isDark
          ...
          >
            <svg
              className={`w-2 h-2 shrink-0 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
