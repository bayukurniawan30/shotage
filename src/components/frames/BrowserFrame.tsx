    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1.5">
          <div className="w-2.5 h-2.5 rounded-full bg-red-500/90 shadow-inner"></div>
          <div className="w-2.5 h-2.5 rounded-full bg-yellow-500/90 shadow-inner"></div>
          <div className="w-2.5 h-2.5 rounded-full bg-green-500/90 shadow-inner"></div>
        </div>

        {/* Safari URL bar */}
        {!isChrome && (
          <div
            className={`flex-1 flex items-center justify-center gap-1.5 mx-6 px-2.5 py-0.5 rounded-md text-[11px] ${
              isDark
        ...
        {isChrome && (
          <div className="flex-1 flex items-center gap-2 ml-3">
            <div className="px-3 py-0.5 bg-slate-900 rounded-t-md border-t border-x border-slate-700/60 text-[11px] font-mono text-slate-300 flex items-center gap-1.5 max-w-[200px]">
              <span className="w-1.5 h-1.5 rounded-full bg-pastel-pink"></span>
