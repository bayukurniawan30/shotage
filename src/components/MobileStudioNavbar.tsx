...
export type MobileTab =
  'image' | 'aspect' | 'frame' | 'style' | 'shadow' | 'perspective' | 'background';
...
export const MobileStudioNavbar: React.FC<MobileStudioNavbarProps> = ({ onImageUpload }) => {
  ...
  return (
    <div className="md:hidden flex flex-col w-full bg-neutral-900 border-t border-neutral-800 shrink-0 z-30">
      ...
      {activeTab && (
        <div className="fixed inset-x-0 bottom-[75px] z-40 bg-neutral-900/95 border-t border-neutral-800 backdrop-blur-xl p-4 max-h-[45vh] overflow-y-auto shadow-2xl animate-in slide-in-from-bottom-4 duration-200">
